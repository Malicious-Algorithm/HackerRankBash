#Given an input file, with N credit card numbers, each in a new line, your task is to grep out and output only those credit card numbers which have two or 
...
#The last case does not have any repeated digits: 1234 5678 910[1] [1]234
